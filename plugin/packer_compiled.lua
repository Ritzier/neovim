...
_G.packer_plugins = {
  ...
  ["FixCursorHold.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/FixCursorHold.nvim",
  ...
  ["cmp-latex-symbols"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/cmp-latex-symbols",
  ...
  ["kotlin-vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/kotlin-vim",
  ...
  ["legendary.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/legendary.nvim",
  ...
  ["neovim-cmake"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/neovim-cmake",
  ...
  ["popui.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/popui.nvim",
...
try_loadstring("\27LJ\2\n#\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\blsp\frequire\0", "config", "nvim-cmp")
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'FixCursorHold.nvim', 'dressing.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
